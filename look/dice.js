...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-97f0333f');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-97f0333f');}
...
var brandEl=document.querySelector('.rl-brand-97f0333f');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
